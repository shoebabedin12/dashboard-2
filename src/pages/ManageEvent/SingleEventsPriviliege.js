import EventsPriviliege from 'components/EventsComponents/EventsPriviliege';
import EventsPriviliegeAddNew from 'components/EventsComponents/EventsPriviliegeAddNew';
import { useState } from 'react';
import { Link } from 'react-router-dom';

const SingleEventsPriviliege = () => {
  ...
  return (
    <>
      <div className="dash_content_main oflow-hd">
        ...
        {!addTicket && <EventsPriviliege setAddTicket={setAddTicket} />}
        {addTicket && <EventsPriviliegeAddNew addTicket={addTicket} setAddTicket={setAddTicket} />}
      </div>
    </>
  );
};

export default SingleEventsPriviliege;
