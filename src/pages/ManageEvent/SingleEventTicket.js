...
import SingleEventTicketCreate from './SingleEventTicketCreate';
import SingleEventTicketEmpty from './SingleEventTicketEmpty';

const SingleEventTicket = () => {
  ...
  return (
    <>
      <div className="dash_content_main oflow-hd">
        ...
        {!createTicket && <SingleEventTicketEmpty setCreateTicket={setCreateTicket} />}
        {createTicket && <SingleEventTicketCreate setCreateTicket={setCreateTicket} />}
      </div>
    </>
  );
};

export default SingleEventTicket;
