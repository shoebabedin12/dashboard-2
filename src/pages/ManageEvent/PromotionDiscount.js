import PromotionDiscountAddComponents from 'components/EventsComponents/PromotionDiscountAddComponents';
import PromotionDiscountComponents from 'components/EventsComponents/PromotionDiscountComponents';
  ...
  return (
    <>
      <div className="dash_content_main oflow-hd">
        ...
        {!addCupon && <PromotionDiscountComponents setAddCupon={setAddCupon} />}
        {addCupon && <PromotionDiscountAddComponents addCupon={addCupon} setAddCupon={setAddCupon} />}
      </div>
    </>
  );
};
